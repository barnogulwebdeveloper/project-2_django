...
class SignInForm(AuthenticationForm):
    username = forms.CharField(widget=forms.TextInput(attrs={'class': 'input'}), label='Ismingizni kiriting')
    password = forms.CharField(widget=forms.PasswordInput(attrs={'class': 'input'}), label='Parolingizni kiriting')
